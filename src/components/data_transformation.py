...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info("Numerical columns standard scaling are completed.")
            logging.info("Categorical columns are encoding completed.")
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            logging.info("Obtaining pre_processing object")
            ...
            logging.info("Applying the preprocessor object on traning dataframe and testing dataframe")
